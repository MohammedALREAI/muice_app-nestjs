...
export interface ISanger {
  ...
  createNewSinger(createNewSinger: CreateNewSingerDto, image: string): Promise<Singer>

  updateSinger(updateSingerDto: UpdateSingerDto): Promise<Singer>

  deleteSinger(singerId: number): Promise<DeleteResult>

  createNewAlbum(singerId: number, createAlbumDto: CreateAlbumDto): Promise<SingerAlbum>
